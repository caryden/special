#!/usr/bin/env python3
"""Extract token usage from mathexpr SONNET subagent JSONL logs."""
import json, os

AGENT_MAP = {
    "agent-a123898": "REF → Python",
    "agent-a500c31": "REF → Rust",
    "agent-a048925": "REF → Go",
    "agent-ab59d4f": "SPEC → Python",
    "agent-a2c1c72": "SPEC → Rust",
    "agent-aae540f": "SPEC → Go",
    "agent-ab52b57": "PROMPT → Python",
    "agent-a9908e8": "PROMPT → Rust",
    "agent-aba7a6e": "PROMPT → Go",
}

BASE_DIRS = [
    "/root/.claude/projects/-home-user-special/c890b14d-72d1-43de-8718-83f62a721181/subagents",
]
...
print("Token Usage per Experiment (mathexpr — SONNET)")
print("=" * 95)
